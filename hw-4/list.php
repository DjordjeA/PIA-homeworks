...
<input class="cleanButton" type="submit" value="Trazi film"><br><br>
</form>

<form action="addmovie.php">
<input class="yesButton" type="submit" value="Dodaj novi film"><br><br>
</form>
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) { // Repeat this x Amount of movies.
        ...
        echo "</div><div class='padding'>Added by: " . $addedBy . "</div>"; 
        echo "</span>";
        ...
        echo "</span>";
            ...
            echo "<input class='movie-remove' type='submit' value='Izbrisi iz filmova'></form>";

        echo "</div><br>";

    }
} else { 
    echo "<div class='noButton'><br>Nema filmova u bazi.Dodaj neki.<br><br></div>";
}
